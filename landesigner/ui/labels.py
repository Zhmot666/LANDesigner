...
DEVICE_ROLE_RU: dict[DeviceRole, str] = {
    ...
    DeviceRole.FIREWALL: "Межсетевой экран",
    DeviceRole.LOAD_BALANCER: "Балансировщик",
    DeviceRole.AP: "Точка доступа",
    DeviceRole.CONTROLLER: "Контроллер (Wi‑Fi)",
    DeviceRole.SERVER: "Сервер",
    DeviceRole.STORAGE: "СХД / NAS",
    ...
    DeviceRole.ODF: "Оптическая панель (ODF)",
    DeviceRole.PDU: "PDU",
    DeviceRole.UPS: "ИБП",
    DeviceRole.KVM: "KVM-консоль",
    DeviceRole.NVR: "Видеорегистратор",
    DeviceRole.IP_PHONE: "IP-телефон",
    DeviceRole.PRINTER: "Принтер / МФУ",
    DeviceRole.MODEM: "Модем / шлюз",
